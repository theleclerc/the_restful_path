...
int min_distance(std::vector<int> Pc, std::vector<Distance> distances) {
    Distance min(-1);
    int s = -1;
...
void mise_a_jour_sommet(int s, std::vector<extremite*> ttlesextremites, std::vector<Distance> distances, std::vector<troncon*> ttlestroncons, std::vector<int>& predecesseurs) {
...
std::vector<int> chemin_plus_court(std::vector<extremite*> ttlesextremites, std::vector<troncon*> ttlestroncons, extremite* depart, extremite* arrivee) {
    ...
    vector<Distance> distances(ttlesextremites.size());
    std::vector<int> P;
    std::vector<int> Pc;
